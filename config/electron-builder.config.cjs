...
module.exports = {
  ...
  mac: {
    ...
    extendInfo: {
      NSAppleEventsUsageDescription:
        'BuildEx allows terminal-launched developer tools to automate local apps when you request it.',
      NSBluetoothAlwaysUsageDescription:
        'BuildEx allows terminal-launched developer tools to access Bluetooth devices when you request it.',
      NSBluetoothPeripheralUsageDescription:
        'BuildEx allows terminal-launched developer tools to access Bluetooth devices when you request it.',
      NSCameraUsageDescription: "Application requests access to the device's camera.",
      NSLocationUsageDescription:
        'BuildEx allows terminal-launched developer tools to access location when you request it.',
      NSLocalNetworkUsageDescription:
        'BuildEx allows terminal-launched developer tools to discover and connect to local development servers when you request it.',
      NSMicrophoneUsageDescription: "Application requests access to the device's microphone.",
      NSAudioCaptureUsageDescription:
        'BuildEx allows terminal-launched developer tools to capture desktop audio when you request it.',
  ...
  dmg: {
    artifactName: 'buildex-macos-${arch}.${ext}'
  },
  linux: {
  ...
  npmRebuild: true,
  // Why: must match src/shared/buildex-release.ts. A fork that publishes to (or
  // updates from) stablyai/orca ships its users into a different product.
  publish: {
    provider: 'github',
    owner: 'dejankeri',
    repo: 'buildex',
