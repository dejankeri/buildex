...
export const SOURCE_CONTROL_ACTION_VARIABLE_INFO = {
  basePrompt: {
    description:
      'BuildEx’s built-in prompt for this action, including the context BuildEx knows how to gather safely.',
    example:
  ...
  firstPrompt: {
    description: 'The first user request that created the BuildEx workspace.',
    example: 'Fix CI and commit the result'
  },
  assistantMessage: {
    description: 'The initial agent response, when BuildEx has one available.',
