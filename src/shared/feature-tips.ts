...
export const FEATURE_TIPS = [
  {
    ...
    priority: 'new',
    eyebrow: 'Tip',
    title: 'Let agents drive BuildEx with the Orca CLI',
  ...
  },
  {
    ...
    description:
      'Speak into any focused pane and BuildEx will transcribe it. Press the dictation shortcut to start and stop.',
    action: 'enable-voice',
