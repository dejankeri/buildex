...
export const FEATURE_WALL_TILES: readonly FeatureWallTile[] = [
  ...
  },
  {
    ...
    caption:
      'Run agents on a remote machine with the same BuildEx editing, git, and terminal workflow.',
    gifPath: 'tile-06.gif',
  ...
  },
  {
    ...
    kind: 'media',
    title: 'Orca CLI',
    caption: 'Agents can drive BuildEx too: create workspaces, snapshot screens, click, and fill.',
    gifPath: 'tile-09.gif',
