...
export const FEATURE_WALL_WORKFLOWS: readonly FeatureWallWorkflow[] = [
  {
    ...
    lede: 'BuildEx splits each task into an isolated workspace so agents can run in parallel.',
  ...
  },
  {
    ...
    lede: 'Run several agents at once, track their progress, and let automation drive BuildEx when it helps.',
  ...
  },
  {
    ...
    lede: 'Bring your terminal setup into BuildEx, then split panes to keep servers, tests, logs, and agents running side by side.',
