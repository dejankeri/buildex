...
export const FEATURE_WALL_SETUP_STEPS: readonly FeatureWallSetupStep[] = [
  ...
  {
    id: 'browser',
    name: "Use BuildEx's browser",
    subtitle: "Use BuildEx's browser",
    description:
      'Browse your web app without leaving BuildEx. Grab any element and send its exact source and styles to an agent with one click.'
  },
  {
    id: 'notifications',
  ...
  },
  {
    ...
    description:
      'Register the BuildEx shell command and install agent skills for browser, computer, and orchestration workflows.'
  },
  {
    id: 'task-sources',
  ...
  },
  {
    ...
    description:
      'Bring your key repos into BuildEx so you can start agent work without hunting for folders.'
  }
] as const
