...
// Why: must track electron-builder's appId, or macOS notifications resolve to a
// bundle that is not this app. See BUILDEX-PATCHES.md.
const MACOS_PACKAGED_BUNDLE_ID = 'com.buildex.app'
