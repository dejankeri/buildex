...
// unchanged. NOT the company-level activity ledger invariant 5 calls for - that is activity/ in the
// team brain (brain/ledger.ts): a loop run's gated moments land there as the broker resolves them,
// while what lives here is only the schedule and its local run state.
//
