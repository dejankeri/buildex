...
const EXPOSE = [
  ...
  "onAddShortcut", "openAddAppForm", "openAddMenu", "openAppTab",
  "openBrainTab", "openBrowserTab", "openChatTab", "openConnectorEditor", "openDocTab", "openFilesSettings",
  "openMapTab", "openMarkdownEditor", "openMcpEditor", "openProfile", "openLogoutConfirm", "openProjectItem", "openSaveMenu", "openSaveDialog", "locationLabel",
  ...
  "loopRunStrip", "runSentence", "runMarkClass", "runWhen", "openLoopHistory", "noticeLoopChanges",
